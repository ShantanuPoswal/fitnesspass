...
let fullLengthWP=[
    ...
    },
    {
        ...
        overview3:"Program Guide: FB Fit30 includes a daily guide that walks you through every step of the way, and also includes featured content from Doctors of Physical Therapy, Certified Personal Trainers, Doctoral-level Mental Health Professionals, and Registered Dietitians (Meet the fitpass Team). ",
    },
    {
        // logo:"FB Plus",
        ...
        overview3:"FB Strong guide & content: FB Strong includes a short daily guide that walks you through every step of the way, also including featured content from Doctors of Physical Therapy, Certified Personal Trainers, Doctoral-level Mental Health Professionals, and Registered Dietitians (Meet the fitpass Team!). Between all of the workout video options in this program, it's comprised of 30 new (to FB Strong) videos, 1 previously unreleased Plus workout, and 10 of the fitpass Community's all-time favorite strength workouts. These programs can be completed in any order (find Strong Round 1 here). Your trainers are Kelli, Daniel, and Tasha, with appearances by Kayla, and Amanda. This program was built by Kelli.",
    },
    {
...
let quickWC=[
    ...
    },
    {
        ...
        subtitle:"Included with FB Plus!",
        overview1:"Welcome to fitpass’s Kettlebell Blend Program! This 2-week challenge is designed for those who want to utilize kettlebells in a more structured approach. There are many benefits to kettlebell training, including: By the end of your 2 weeks, you should notice marked improvements in all of these areas.",
